...
init したら、まずこの2つを試してみてください:

1. **トップページを編集する** — `pages/en/index.md`（または `pages/ja/index.md`）を開いて、サンプルテキストを自分のプロジェクトの説明に書き換えます。
2. **favicon を差し替える** — `static/` に自分の `favicon.svg` を置くと、デフォルトのアイコンが上書きされます。
